...
until runmode = -1 {
    ...
    print "CONTROLS:" at (0,18).
    print "W: Increase target speed" at (0,19).
    print "S: Decrease target speed" at (0,20).
    print "Brakes: Reset cruise control to 0 and come to a stop" at (0,21).
    print "AG1: Toggle autopilot" at (0,22).
    print "AG2: Set autopilot target to current heading" at(0,23).
    print "AG3: Adjust target heading by -0.5 degrees" at(0,24).
    print "AG4: Adjust target heading by +0.5 degrees" at(0,25).
